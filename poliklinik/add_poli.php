...
?>
    ...
    <div class="box">
        ...
        <div class="pull-right">
            ...
            <a href="generate.php" class="btn btn-success btn-xs"><i class="glyphicon glyphicon-plus"></i> Tambah data lagi</a>
        </div>
        </h4>
                ...
                <form action="proses.php" method="post">
                    <div class="form-group">
                        ...
                        <div class="form-group pull-right">
                            <input type="submit" name="addpoli" value="Save all" class="btn btn-success btn-sm" required>
                        </div>
                    </div>
                </form>
            </div>
