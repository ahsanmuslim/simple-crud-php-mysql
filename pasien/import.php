...
<div class="box">
        ...
        <div class="pull-right">
            <a href="../file/sample/pasien.xlsx" class="btn btn-default btn-xs"><i class="glyphicon glyphicon-download-alt"></i> Download Contoh File</a>
            ...
            <div class="col-lg-6 col-lg-offset-3">
                <form action="proses.php" method="post" enctype="multipart/form-data"> 
                    <div class="form-group">
                        ...
                        <input type="file" name="file_import" id="file_import" class="form-control" require autofocus>
                    </div>
                    <div class="form-group">
